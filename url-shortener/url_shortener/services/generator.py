...
def search_original_url(db: Session, short_url: str) -> ShortURL:
    ...
    if not result:
        raise HTTPException(
            status_code=500, detail="No original URL found for the given short URL"
        )
